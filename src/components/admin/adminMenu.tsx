import { Building2, CalendarCheck2, Contact, LayoutGrid, MessageSquareQuote, Users } from "lucide-react";
...
export const adminMenu: DashboardMenuItem[] = [
  ...
  { label: "Reviews", href: "/admin/reviews", icon: <MessageSquareQuote className="h-4 w-4" /> },
